# UgCitizen Resolve Portal: Citizen Engagement & Service Delivery Portal

## Thematic Area
**Area 11: Citizen Engagement & Service Delivery** (e-Government portals, mobile services, complaint management)
...
2. **Government Triage Dashboard:** A secure backend for MDA agents to view a map of reported issues, assign them to local response teams, update statuses (e.g., "Received", "In Progress", "Resolved"), and communicate resolutions back to the citizen.

This prototype directly addresses the Call by providing a locally-built, highly visible tool that improves government responsiveness and citizen trust.