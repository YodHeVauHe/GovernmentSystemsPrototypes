...
function AddApiModal({ onClose }: { onClose: () => void }) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-sm p-4">
      <div className="bg-[#1c1c1c] border border-[#2e2e2e] rounded-xl w-full max-w-lg shadow-2xl p-6">
        <h2 className="text-[16px] font-medium text-white mb-4">Add New API to Catalog</h2>
        <div className="text-[13px] text-[#8b8b8b] mb-4">
          <p>API addition functionality requires integration with the backend Registry service.</p>
          <p className="mt-2">This is a UI placeholder.</p>
        </div>
        <button onClick={onClose} className="w-full h-[36px] bg-[#3ecf8e] text-black font-medium rounded-md text-[13px]">
          Close
        </button>
      </div>
    </div>
